...
extension OBDCommand.Mode1 {
    var properties: CommandProperties {
        ...
        case .distanceWMIL: return CommandProperties("0121", "Distance Traveled with MIL on", 3, .uas(0x25), true)
        ...
        case .O2Sensor1WRCurrent: return CommandProperties("0134", "02 Sensor 1 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor2WRCurrent: return CommandProperties("0135", "02 Sensor 2 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor3WRCurrent: return CommandProperties("0136", "02 Sensor 3 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor4WRCurrent: return CommandProperties("0137", "02 Sensor 4 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor5WRCurrent: return CommandProperties("0138", "02 Sensor 5 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor6WRCurrent: return CommandProperties("0139", "02 Sensor 6 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor7WRCurrent: return CommandProperties("013A", "02 Sensor 7 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        case .O2Sensor8WRCurrent: return CommandProperties("013B", "02 Sensor 8 WR Lambda Current", 5, .currentCentered, true, maxValue: 128, minValue: -128)
        ...
        case .absoluteLoad: return CommandProperties("0143", "Absolute load value", 3, .absoluteLoad, true)
        ...
        case .maxValues: return CommandProperties("014F", "Maximum value for various values", 5, .none)
        case .maxMAF: return CommandProperties("0150", "Maximum value for air flow rate from mass air flow sensor", 5, .maxMaf, true)
        ...
        case .evapVaporPressureAbs: return CommandProperties("0153", "Absolute Evap system vapor pressure", 3, .absEvapPressure, true)
        ...
        case .hybridBatteryLife: return CommandProperties("015B", "Hybrid battery pack remaining life", 2, .percent)
